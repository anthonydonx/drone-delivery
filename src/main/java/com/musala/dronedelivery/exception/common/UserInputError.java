...
public class UserInputError extends RuntimeException{
     ...
     * @since 1.4
     */
    public UserInputError(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public UserInputError(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public UserInputError(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
